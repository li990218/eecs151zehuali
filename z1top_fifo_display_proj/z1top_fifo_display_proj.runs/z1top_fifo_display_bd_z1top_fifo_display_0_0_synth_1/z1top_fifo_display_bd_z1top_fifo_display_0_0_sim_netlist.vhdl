...
-- Date        : Wed Feb 26 17:32:32 2020
-- Host        : c125m-5.EECS.Berkeley.EDU running 64-bit CentOS Linux release 7.7.1908 (Core)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ z1top_fifo_display_bd_z1top_fifo_display_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE is
  port (
    LEDS : out STD_LOGIC_VECTOR ( 0 to 0 );
    \q_reg[0]_0\ : in STD_LOGIC;
    pixel_clk : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_0 is
  port (
    LEDS : out STD_LOGIC_VECTOR ( 0 to 0 );
    \q_reg[0]_0\ : in STD_LOGIC;
    pixel_clk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_0 : entity is "REGISTER_R_CE";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_0 is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_1 is
  port (
    LEDS : out STD_LOGIC_VECTOR ( 0 to 0 );
    \q_reg[0]_0\ : in STD_LOGIC;
    pixel_clk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_1 : entity is "REGISTER_R_CE";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_1;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_1 is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_2 is
  port (
    LEDS : out STD_LOGIC_VECTOR ( 0 to 0 );
    \q_reg[0]_0\ : in STD_LOGIC;
    pixel_clk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_2 : entity is "REGISTER_R_CE";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_2;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_2 is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3\ : entity is "REGISTER_R_CE";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3_3\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3_3\ : entity is "REGISTER_R_CE";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3_3\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3_3\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_button_parser is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_button_parser;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_button_parser is
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer is
  port (
    clk : in STD_LOGIC;
    glitchy_signal : in STD_LOGIC_VECTOR ( 3 downto 0 );
    debounced_signal : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer;
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector is
  port (
    clk : in STD_LOGIC;
    signal_in : in STD_LOGIC_VECTOR ( 3 downto 0 );
    edge_detect_pulse : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector;
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_synchronizer is
  port (
    async_signal : in STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    sync_signal : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_synchronizer;
...
begin
button_debouncer: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer
     port map (
      clk => pixel_clk,
      debounced_signal(3 downto 0) => debounced_signals(3 downto 0),
      glitchy_signal(3 downto 0) => synchronized_signals(3 downto 0)
    );
button_edge_detector: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector
     port map (
      clk => pixel_clk,
      edge_detect_pulse(3 downto 0) => buttons_pressed(3 downto 0),
      signal_in(3 downto 0) => debounced_signals(3 downto 0)
    );
button_synchronizer: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_synchronizer
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display_controller is
  port (
    video_out_pVSync : out STD_LOGIC;
    video_out_pVDE : out STD_LOGIC;
    video_out_pHSync : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display_controller;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display_controller is
...
begin
x_pixel: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3\
     port map (
      pixel_clk => pixel_clk,
...
y_pixel: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE__parameterized3_3\
     port map (
      pixel_clk => pixel_clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_z1top_fifo_display is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_z1top_fifo_display;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_z1top_fifo_display is
...
begin
  ...
  pixel_clk <= \^pixel_clk\;
blue_enable_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE
     port map (
      LEDS(0) => \^leds\(0),
      pixel_clk => \^pixel_clk\,
      \q_reg[0]_0\ => bp_n_1
    );
bp: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_button_parser
     port map (
...
clk_wiz: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz
     port map (
      CLK_125MHZ_FPGA => CLK_125MHZ_FPGA,
      clk_out1 => \^pixel_clk\
    );
display_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_display_controller
     port map (
      pixel_clk => \^pixel_clk\,
      video_out_pHSync => video_out_pHSync,
      video_out_pVDE => video_out_pVDE,
...
gray_enable_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_0
     port map (
      LEDS(0) => \^leds\(3),
      pixel_clk => \^pixel_clk\,
      \q_reg[0]_0\ => bp_n_3
    );
green_enable_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_1
     port map (
      LEDS(0) => \^leds\(1),
      pixel_clk => \^pixel_clk\,
      \q_reg[0]_0\ => bp_n_0
    );
red_enable_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_REGISTER_R_CE_2
     port map (
      LEDS(0) => \^leds\(2),
      pixel_clk => \^pixel_clk\,
      \q_reg[0]_0\ => bp_n_2
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "z1top_fifo_display_bd_z1top_fifo_display_0_0,z1top_fifo_display,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "z1top_fifo_display,Vivado 2019.1";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_z1top_fifo_display
     port map (
      BUTTONS(3 downto 0) => BUTTONS(3 downto 0),
      CLK_125MHZ_FPGA => CLK_125MHZ_FPGA,
      LEDS(3 downto 0) => LEDS(3 downto 0),
